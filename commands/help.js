export default function(args, socket, usersOnline, room, rooms, saveChatHistory) {
  const serverMessages = [
    ...
    { user: 'server', text: `/levelUp <username> helpt je om het level te verhogen van de gebruiker.` },
    { user: 'server', text: `/levelDown <username> helpt je om het level te verlagen van de gebruiker.` },
  ];
